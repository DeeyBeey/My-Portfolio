        ...
        <section id="experience">
            ...
            <div className="experience-item">
                ...
                <ul>
                    ...
                    Python's NumPy and Pandas library, identifying key insights and presented findings resulting in a 10% enhancement in KPIs.</li>
                    <li>Leveraged AWS cloud services to optimize data storage and ELT data pipelines, resulting in a 30% reduction in 
                    infrastructure costs while maintaining high scalability and reliability for the data analytics platform.</li>
